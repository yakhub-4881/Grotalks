            ...
            <div className="p-8 md:p-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <div className="flex flex-col items-center text-center p-6 rounded-lg bg-background/50">
                  ...
                  <p className="text-sm text-muted-foreground">Set your own rates and earn while alumniing</p>
                </div>
                <div className="flex flex-col items-center text-center p-6 rounded-lg bg-background/50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start gap-3 p-4 rounded-lg bg-background/50">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">Quality alumnihip standard</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mb-3">
                      The alumni application can only be activated after you begin your first internship or job. 
